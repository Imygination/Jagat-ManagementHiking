<template>
  <div>
            ...
            <div class="mask" style="background-color: rgba(0, 0, 0, 0.6)">
              <div class="d-flex justify-content-center align-items-center h-100">
                ...
                <form>
                  ...
                  <div class="row ps-5">
                    <div class="col mt-5">
                      <label class="form-label text-white" for="form6Example1">DESTINATION</label>
                    ...
                    <div class="col mt-3">
                      <label class="form-label text-white" for="form6Example1">DATE</label>
                      <div class="form-outline">
                        <input
                          type="date"
                          id="form6Example1"
                  ...
                  <!-- Text input -->
                  <div class="form-outline ps-5 mb-4 pt-3">
                    <label class="form-label text-white" for="form6Example3"
                      >Your Active Email</label
                    >
                    <input
                      type="email"
                      id="form6Example3"
                ...
                <!-- <div class="text-white text-center">
                  <h1 class="mb-3">READY FOR ADVENTURE</h1>
                  <h5 class="mb-4">Best & free guide for Traveller</h5>
                  <a
    ...
    <div style="margin-left: 150px; margin-top: 300px">
      <div class="wrapper">
        <ul class="StepProgress">
          <div class="StepProgress-item current"><strong>Post a contest</strong></div>
          <div class="StepProgress-item current">
            <strong>Award an entry</strong>
            Got more entries that you love? Buy more entries anytime! Just hover on your favorite
            entry and click the Buy button
          </div>
          <div class="StepProgress-item current"><strong>Post a contest</strong></div>
          <div class="StepProgress-item current"><strong>Handover</strong></div>
